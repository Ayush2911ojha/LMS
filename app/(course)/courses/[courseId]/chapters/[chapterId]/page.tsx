...
import { getQuizQuestions } from "@/actions/get-quiz";
import QuizSection from "./_components/QuizSection";
// import { useState } from "react";
import { Button } from "@/components/ui/button"
import { Lock } from "lucide-react" // optional lock icon
import QuizClientWrapper from "./_components/QuizClientWrapper";
...
const ChapterIdPage = async ({
  ...
  const quizQuestions = await getQuizQuestions(params.courseId);
    //  const [quizStarted, setQuizStarted] = useState(false)

  const courseComplete = !!userProgress?.isCompleted 
    ...
    {!courseComplete ? (
      <div className="p-4 bg-white rounded-lg shadow-sm text-center">
        ...
        <p className="font-medium text-gray-600">
          Complete all chapters to unlock the quiz.
        </p>
